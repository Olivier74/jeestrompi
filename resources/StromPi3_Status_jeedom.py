...
try:
    ...
    print('' + str(int(sp3_output_status)) + '|' + str(sp3_ADC_BAT) + '|' + batterylevel_converter(int(sp3_batLevel),int(sp3_charging)) + '|' + str(sp3_ADC_Wide)+ '|' + str(sp3_ADC_USB) + '|' + str(sp3_ADC_OUTPUT))
