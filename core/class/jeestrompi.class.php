...
/*public function toHtml($_version = 'dashboard') {
 ...
 $StromPiLifePo4Charge = $this->getCmd(null, 'StromPiLifePo4Charge');
  ...
  //$StromPiLifePo4Charge->setTemplate('dashboard','strompimode');//template pour le dashboard
  //$StromPiLifePo4Charge->setTemplate('mobile','strompimode');//template pour le dashboard
