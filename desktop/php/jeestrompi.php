...
<div class="row row-overflow">
	...
	<div class="col-xs-12 eqLogicThumbnailDisplay">
		...
		<?php
		if (count($eqLogics) == 0) {
			echo '<br><div class="text-center" style="font-size:1.2em;font-weight:bold;">{{Aucun équipement jeestrompi trouvé, cliquer sur "Ajouter" pour commencer}}</div>';
		} else {
			// Champ de recherche
						...
						<div class="col-lg-6">
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<select id="sel_object_StrompiModeConfig" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="StrompiModeConfig">
                                      <option selected="selected" value="0">{{pas de synchronisation}}</option>
                                      <option value="1">{{1 = mUSB -> Wide}}</option>
                                      <option value="2">{{2 = Wide -> mUSB}}</option>
                            ...
                            <div class="form-group">
                                 ...
                                 <span style="display : none;">'</span>
 								 <div class="col-sm-6">
									<a class="btn btn-sm btn-success roundedLeft" id="bt_StrompiChangeMode"><i class="fa fa-check-circle"></i> {{Modifier le mode}}</a>
								 </div>
                            </div>
							<div class="form-group">
...
<?php include_file('desktop', 'jeestrompi', 'js', 'jeestrompi'); ?>
